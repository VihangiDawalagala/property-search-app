// Search form component with filters for property type, price, bedrooms, date, and postcode
...
export function SearchForm({ onSearch }) {
  // State variables to store all the filter values user selects
  ...
  // Collects all filter values and sends them to parent component to search properties
  const handleSearch = () => {
    const criteria = {
      type: type === "any" ? undefined : type,
      minPrice: minPrice > 150000 ? minPrice : undefined,
      maxPrice: maxPrice < 900000 ? maxPrice : undefined,
  ...
  // Resets all filters back to default values and clears search results
  const handleReset = () => {
    setType("any")
    setMinPrice(150000)
    setMaxPrice(900000)
          ...
          <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
            <div className="text-center">
              ...
              <p className="text-lg font-bold text-foreground">
                {minPrice === 150000 ? "Any" : `£${minPrice.toLocaleString()}`}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-lg font-bold text-foreground">
                £{maxPrice === 900000 ? "900K+" : maxPrice.toLocaleString()}
              </p>
            </div>
          </div>
          <div className="space-y-4">
